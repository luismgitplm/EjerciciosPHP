...
<body>
    ...
    <form action="11calculo-nota.php" method = "get" class = "m-auto p-3 w-50" >
        <h2>Petición de notas</h2>
        <div class = "mb-3">
            <label for = "nota1" class = "form-label">Introduce la primera nota:</label>
            <input type = "number" step = "0.01" class = "form-control" name = "nota1" id = "nota1">
        </div>
        <div class = "mb-3">
            <label for = "nota2" class = "form-label">Introduce la segunda nota:</label>
            <input type = "number" step = "0.01" class = "form-control" name = "nota2" id = "nota2">
        </div>
        <div class = "mb-3">
            <label for = "faltas" class = "form-label">Indica el número de faltas</label>
            <input type = "number" step = "0.01" class = "form-control" name = "faltas" id = "faltas">
        </div>
